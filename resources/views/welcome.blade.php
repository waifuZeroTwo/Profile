            ...
            <article class="card">
                ...
                <div class="rows">
                    ...
                    <div class="row">
                        ...
                        <div class="v">netherlands (0–5, 12–21); lebanon (5–12)</div>
                    </div>
                    <div class="row">
                        <div class="k">travel</div>
                        <div class="v">solo japan (jun ’24). usa (may ’25) to meet gta rp friends.</div>
                    </div>
                    <div class="row">
                        <div class="k">beliefs</div>
                        <div class="v">atheistic; curious about culture & language.</div>
                    </div>
                    <div class="row">
                        <div class="k">social energy</div>
                        <div class="v">small-group creature (max 4). bigger crowds turn me quiet. replies may be slow but honest.</div>
                    </div>
                    <div class="row">
                        <div class="k">now</div>
                        <div class="v">a little depressed sometimes; focused on work, study, languages & learning.</div>
                    </div>
                </div>
            </article>
            ...
            <div class="rows" style="margin-bottom:10px">
                <div class="row">
                    ...
                    <div class="v">
                        ...
                        <button class="copy" id="copyDiscord" aria-label="copy discord handle" title="Copy">
                ...
                <div class="row">
                    ...
                    <div class="v">
                        <a class="link" href="https://zerotwolove.nl" target="_blank" rel="noopener">zerotwolove.nl</a>
                    </div>
                </div>
            </div>
...
Tim — 2:20 PM: 3:30</pre>
                    <p style="margin-top:8px;opacity:.85">one-word openers slow things down. just ask the question. 😫</p>
                </div>
...
Tim — 2:15 PM: 3:30
Dawn — 2:15 PM: ta — see you then!</pre>
                    <p style="margin-top:8px;opacity:.9">pleasantries + the ask works great. examples i reply to:</p>
                    <p style="margin-top:6px;opacity:.9">
                        • “yo zero, free this week to duo in valorant? tue or wed night?”<br>
                        • “hi! curious how you undervolt your 7900x—mind sharing?”<br>
                        • “hey, i’m learning jp too (n5). want to practice 10 min voice?”
                    </p>
                </div>
            </div>
        </section>
        ...
        <section class="card" id="contact">
            ...
            <p>always down to meet new people—slow burn. start with context, not just “hi”.</p>
            <div class="actions" style="margin-top:14px">
                <a class="btn alt" href="#reach">discord details</a>
                <a class="btn ghost" href="https://zerotwolove.nl" target="_blank" rel="noopener">waifu site</a>
            </div>
        </section>
    </main>
